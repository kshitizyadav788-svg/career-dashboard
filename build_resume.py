...
DATA = {
    ...
    "roles": [
        {"title": "Product Manager", "dates": "Sep 2023 – Present", "bullets": [
            ...
            "Built a self-serve, product-led enrolment flow from scratch — post-demo course selection with best-fit ranking, single-step OTP, discounts, and 6 API-integrated payment gateways with auto-cleared approvals — letting customers purchase on their own; grew this new channel from 6% of leads at launch to 12% (at 95% payment success) over 12 months of iteration, reducing reliance on counselor- and teacher-assisted sales.",
            "Scaled a parallel teacher-led enrolment channel — teachers collect payment from customers during the demo session — growing its monthly revenue from ₹30L to ₹50L at ~20% conversion.",
