...
DATA = {
    ...
    "experience": {
        ...
        "intro": "Own the full product suite of a B2C EdTech startup: consumer app, student & teacher LMS, sales CRM, product-led growth & renewal engine, and an in-house AI layer.",
        "groups": [
